<?php include 'collegevalidations.php';?>
<html>
	<head>
		<script>
			var hasError=false;
			...
			function validate(){
				...
				if(get("cid").value == ""){
					hasError = true;
					get("err_cid").innerHTML = "*College Id Req";
				}
	...
	<body>
		...
		<fieldset>
		<?php
		    echo"<h1>Create College Account<h1>";
		?>
			<table>
				<tr>
					<td>First_Name</td>
				...
				<tr>
					<td>College Id</td>
					<td>: <input type="text" id="cid" name="cid" placeholder="Enter College Id">  </td>
					<td><span id="err_cid"> <?php echo $err_cid;?> </span></td>
				</tr>
				 <tr>
                        <td>Password</td>
